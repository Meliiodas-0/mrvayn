...
export const profile = {
  ...
  thesis:
    "I build AAA-caliber game feel in Unreal Engine 5 — gameplay systems, Niagara VFX, and multiplayer that ships — and full-stack web apps with Next.js, TypeScript, React, Tailwind, and Postgres.",
