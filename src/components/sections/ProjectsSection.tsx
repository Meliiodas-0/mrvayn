            ...
            >
              {project.locked ? (
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="card-cinematic p-4 sm:p-5 block group transition-all duration-300 border-primary/30 shadow-[0_0_20px_hsl(var(--primary)/0.15),0_0_40px_hsl(var(--primary)/0.08)] hover:border-primary/60 hover:shadow-[0_0_30px_hsl(var(--primary)/0.25),0_0_60px_hsl(var(--primary)/0.1)]"
                >
