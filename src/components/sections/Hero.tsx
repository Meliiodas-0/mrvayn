...
export function Hero() {
  return (
    <section id="hero" className="relative flex min-h-screen items-center justify-center overflow-hidden px-5 pb-16 pt-28">
      {/* VFX: signature neon glow (surge -> ion -> volt), blurred, low opacity. */}
      <div
        aria-hidden
        className="pointer-events-none absolute left-1/2 top-1/2 -z-0 h-[44rem] w-[44rem] -translate-x-1/2 -translate-y-1/2 rounded-full opacity-25 blur-[130px]"
        style={{
          background:
      ...
      <div className="relative z-10 mx-auto flex max-w-3xl flex-col items-center text-center">
        ...
        <Reveal delay={0.08}>
          <h1
            className="mt-6 font-anton uppercase leading-[0.86] text-bone text-glow-surge"
